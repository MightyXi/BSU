...
int main()
{
    ...
    start = std::chrono::steady_clock::now();
    std::vector<double> x3 = pcg(matrix, f, xZero, M2);
    end = std::chrono::steady_clock::now();
    ...
    std::cout << "pcg with jakobi" << "\n";

    std::cout << "5 cordinats of solution ";
    print5(x2);
    std::cout << "otnositelnaya pogreshnost " << relativeError(x2, x) << "\n";
    std::cout << "Norma vectora nevyazki " << vectorNevyazki(matrix, x2, f) << "\n";
    ...
    std::cout << "Norma vectora nevyazki " << vectorNevyazki(matrix, x3, f) << "\n";
